...
/**
 * Created by ChenYesheng On 2021/4/12 9:28
 * Desc: 自第一view
 */
public class cancasView extends View {

    private int defalutSize;

    public cancasView(Context context) {
        super(context);
    }

    public cancasView(Context context, AttributeSet attrs) {
        super(context, attrs);
