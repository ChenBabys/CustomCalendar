    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mDataList != null) {
            ...
            if ((TextUtils.equals(CalendarTool.SATURDAY,
                    ...
                    mDataList.get(position).weekDay)) {
                // 周末背景为白，字体为灰色
                textView.setTextColor(Color.parseColor("#208CF9"));
                ...
                if (((mDataList.get(position).year == 2015 && mDataList
                        ...
                        && mDataList.get(position).isSelfMonthDate) {// 2015.8以前，且日期在当月
            ...
            if (mDataList.get(position).isNowDate
                ...
                textView.setBackgroundColor(Color.parseColor("#208CF9"));
