...
//                    + mNowCalendarPoint.y + "月");
    ...
    private class CalendarRvViewAdapter extends RecyclerView.Adapter<CalendarRvViewAdapter.CalendarViewHolder> {
        ...
        public CalendarViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            dayView.setLayoutParams(new LayoutParams(dp2px(50), dp2px(50)));
...
//                dayView.setEmptyColor(todayEmptyColor);
//                dayView.setFillColor(todayFillColor);
...
//                //可选时间
//                dayView.setTextColor(enableSelectColor);
//            } else {
//                //不可选时间
//                dayView.setTextColor(disableSeletColor);
//            }
//            if (eDateTime != null && date.getTime() == eDateTime.getTime()) {
//                //结束时间
//                dayView.isETime(true);
//            }
//            if (sDateTime != null && date.getTime() == sDateTime.getTime()) {
//                //开始时间
//                if (eDateTime != null) {
//                    dayView.isSTime(true);
//                } else {
//                    dayView.isSTime(true);
//                }
//            }
...
//                if (date.getDay() == 6) {
//                    dayView.isDurationSat(true);
//                } else if (date.getDay() == 0) {
//                    dayView.isDurationSun(true);
//                } else {
